...
`Greetings!` I'm a Sr. Applied Scientist specializing in designing innovative algorithmic and data-driven tools which has already empowered organizations like `Bain & Co.`, `OYO Rooms`, and `Dell Technologies` to better serve their users. Few of my notable self-engineered methods include a cosine-similarity based nearest-neighbor text search engine and a binary search based dynamic pricing system. Additionally, I have also developed scalable, production-grade NLP pipelines leveraging large language models for topic and sentiment classification, multilingual translation, and explainable behavioral assessment, enabling data-driven decision-making at scale.
